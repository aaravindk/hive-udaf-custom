...
@Description(name = "lastrow", value = "_FUNC_(expr) - Returns the last value of expr and values of associated columns as a struct")
public class GenericUDAFLastRow extends AbstractGenericUDAFResolver {

  static final Log LOG = LogFactory.getLog(GenericUDAFLastRow.class.getName());
  ...
  public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters) throws SemanticException {
    ...
    return new GenericUDAFLastRowEvaluator();
  }

  // @UDFType(distinctLike=true)
  public static class GenericUDAFLastRowEvaluator extends GenericUDAFEvaluator {
